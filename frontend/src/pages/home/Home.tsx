  ...
  return (
    <div className={style.container}>
      <section className={style.hero}>
        <h1 className={style.title}>Bienvenido a mi tienda</h1>
        <p>
          Controla tu inventario de forma sencilla, una herramienta diseñada
          para ayudarte a gestionar productos, stock y precios de manera rápida
          y organizada.
        </p>
      </section>
